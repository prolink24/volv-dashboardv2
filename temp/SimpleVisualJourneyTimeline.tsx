...
import { Calendar, Activity, DollarSign, FileText, MessageSquare, Clock } from 'lucide-react';
          ...
          <div key={date} className="relative">
            ...
            <div className="space-y-6 ml-14">
              {eventsByDate[date].map((event, eventIndex) => (
                <Card key={event.id} className="p-4 shadow-sm border-l-4" style={{ borderLeftColor: event.source === 'Close' ? '#3498db' : event.source === 'Calendly' ? '#2ecc71' : '#9b59b6' }}>
